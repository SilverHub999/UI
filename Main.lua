...
local ClosureBindings = {
	...
	[26] = function()local maui,script,require,getfenv,setfenv=ImportGlobals(26)local UserInputService = game:GetService("UserInputService")
		...
		function Element:New(Idx, Config)
			...
			SliderDisplay.FocusLost:Connect(function(value)
				local data = tonumber(SliderDisplay.Text)
	...
	[48] = function()
		...
		return {
			Name = "Normal Hub",
			Accent = Color3.fromRGB(210, 50, 120),  -- สีชมพู/แดงอมม่วงแบบในภาพ
			AcrylicMain = Color3.fromRGB(15, 15, 20),  -- ดำอมเทาเข้ม
			AcrylicBorder = Color3.fromRGB(40, 40, 50),  -- กรอบเทาเข้ม
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 30, 40), Color3.fromRGB(10, 10, 15)), -- ไล่เฉดดำ
			AcrylicNoise = 0.8,
			TitleBarLine = Color3.fromRGB(40, 40, 50),  -- เส้นแถบเทาเข้ม
			Tab = Color3.fromRGB(210, 50, 120),  -- แถบเลือกสีชมพู/ม่วงเข้ม
			Element = Color3.fromRGB(25, 25, 30),  -- พื้นหลังองค์ประกอบดำ
			ElementBorder = Color3.fromRGB(40, 40, 50),  
			InElementBorder = Color3.fromRGB(50, 50, 60),  
			ElementTransparency = 0.85,
			ToggleSlider = Color3.fromRGB(210, 50, 120),  
			ToggleToggled = Color3.fromRGB(70, 0, 50),  
			SliderRail = Color3.fromRGB(70, 65, 75),  
			DropdownFrame = Color3.fromRGB(30, 30, 35),  
			DropdownHolder = Color3.fromRGB(25, 25, 30),  
			DropdownBorder = Color3.fromRGB(210, 50, 120),  
			DropdownOption = Color3.fromRGB(40, 40, 45),  
			Keybind = Color3.fromRGB(210, 50, 120),  
			Input = Color3.fromRGB(30, 30, 35),  
			InputFocused = Color3.fromRGB(50, 45, 60),  
			InputIndicator = Color3.fromRGB(210, 50, 120),  
			Dialog = Color3.fromRGB(20, 20, 25),  
			DialogHolder = Color3.fromRGB(30, 25, 35),  
			DialogHolderLine = Color3.fromRGB(15, 10, 20),  
			DialogButton = Color3.fromRGB(210, 50, 120),  
			DialogButtonBorder = Color3.fromRGB(210, 50, 120),  
			DialogBorder = Color3.fromRGB(60, 60, 70),  
			DialogInput = Color3.fromRGB(30, 30, 35),  
			DialogInputLine = Color3.fromRGB(210, 50, 120),  
			Text = Color3.fromRGB(255, 255, 255),  
			SubText = Color3.fromRGB(180, 180, 180),  
			Hover = Color3.fromRGB(240, 80, 160),  
			HoverChange = 0.05
		}
	end,
