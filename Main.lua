...
local ClosureBindings = {
	...
	[48] = function()
		...
		return {
			Name = "Normal Hub",
			Accent = Color3.fromRGB(200, 30, 90), -- ชมพูอมม่วง (หลัก)
			AcrylicMain = Color3.fromRGB(10, 10, 10), -- ดำสนิท (พื้นหลังหลัก)
			AcrylicBorder = Color3.fromRGB(40, 40, 40), -- ขอบเทาเข้ม
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(20, 20, 20), Color3.fromRGB(10, 10, 10)),
			AcrylicNoise = 0.9,

			TitleBarLine = Color3.fromRGB(50, 50, 50), -- เส้นคั่นบนสุด

			Tab = Color3.fromRGB(200, 30, 90), -- สีแท็บที่เลือก
			Element = Color3.fromRGB(20, 20, 20), -- กล่อง UI ดำเข้ม
			ElementBorder = Color3.fromRGB(45, 45, 45), -- ขอบเทาเข้ม
			InElementBorder = Color3.fromRGB(35, 35, 35),

			ElementTransparency = 0.85,

			ToggleSlider = Color3.fromRGB(200, 30, 90), -- Toggle slider ชมพูอมม่วง
			ToggleToggled = Color3.fromRGB(60, 0, 40),
			SliderRail = Color3.fromRGB(70, 30, 60),
			...
			Keybind = Color3.fromRGB(200, 30, 90),
			Input = Color3.fromRGB(25, 25, 25),
			InputFocused = Color3.fromRGB(40, 30, 45),
			InputIndicator = Color3.fromRGB(200, 30, 90),

			Dialog = Color3.fromRGB(15, 15, 15),
			DialogHolder = Color3.fromRGB(25, 20, 30),
			DialogHolderLine = Color3.fromRGB(20, 20, 25),
			DialogButton = Color3.fromRGB(200, 30, 90),
			DialogButtonBorder = Color3.fromRGB(200, 30, 90),
			DialogBorder = Color3.fromRGB(40, 40, 40),
			DialogInput = Color3.fromRGB(30, 30, 30),
			DialogInputLine = Color3.fromRGB(200, 30, 90),

			Text = Color3.fromRGB(255, 255, 255),
			SubText = Color3.fromRGB(180, 180, 180),

			Hover = Color3.fromRGB(220, 60, 120), -- Hover สีชมพูสด
			HoverChange = 0.07
		}
	end,
